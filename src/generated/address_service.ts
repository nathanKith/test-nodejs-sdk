...
export interface GetAddressRequest {
  $type: "networkapi.GetAddressRequest";
  /**
...
export interface GetAddressByValueRequest {
  $type: "networkapi.GetAddressByValueRequest";
  externalIpv4Address: string | undefined;
}

export interface ListAddressesRequest {
  $type: "networkapi.ListAddressesRequest";
  /**
...
export interface ListAddressesResponse {
  $type: "networkapi.ListAddressesResponse";
  /** List of addresses. */
  addresses: Address[];
  /**
...
export interface CreateAddressRequest {
  $type: "networkapi.CreateAddressRequest";
  /**
...
export interface CreateAddressRequest_LabelsEntry {
  $type: "networkapi.CreateAddressRequest.LabelsEntry";
  key: string;
  value: string;
}

export interface ExternalIpv4AddressSpec {
  $type: "networkapi.ExternalIpv4AddressSpec";
  /** Value of address. */
  address: string;
...
export interface CreateAddressMetadata {
  $type: "networkapi.CreateAddressMetadata";
  /** ID of the address that is being created. */
  addressId: string;
}

export interface UpdateAddressRequest {
  $type: "networkapi.UpdateAddressRequest";
  /**
...
export interface UpdateAddressRequest_LabelsEntry {
  $type: "networkapi.UpdateAddressRequest.LabelsEntry";
  key: string;
  value: string;
}

export interface UpdateAddressMetadata {
  $type: "networkapi.UpdateAddressMetadata";
  /** ID of the Address that is being updated. */
  addressId: string;
}

export interface DeleteAddressRequest {
  $type: "networkapi.DeleteAddressRequest";
  /**
...
export interface ListAddressOperationsResponse {
  $type: "networkapi.ListAddressOperationsResponse";
...
export interface MoveAddressRequest {
  $type: "networkapi.MoveAddressRequest";
  addressId: string;
  destinationFolderId: string;
}

export interface MoveAddressMetadata {
  $type: "networkapi.MoveAddressMetadata";
  addressId: string;
}
...
export const GetAddressRequest = {
  $type: "networkapi.GetAddressRequest" as const,
...
export const GetAddressByValueRequest = {
  $type: "networkapi.GetAddressByValueRequest" as const,
...
export const ListAddressesRequest = {
  $type: "networkapi.ListAddressesRequest" as const,
...
export const ListAddressesResponse = {
  $type: "networkapi.ListAddressesResponse" as const,
...
export const CreateAddressRequest = {
  $type: "networkapi.CreateAddressRequest" as const,
...
export const CreateAddressRequest_LabelsEntry = {
  $type: "networkapi.CreateAddressRequest.LabelsEntry" as const,
...
export const ExternalIpv4AddressSpec = {
  $type: "networkapi.ExternalIpv4AddressSpec" as const,
...
export const CreateAddressMetadata = {
  $type: "networkapi.CreateAddressMetadata" as const,
...
export const UpdateAddressRequest = {
  $type: "networkapi.UpdateAddressRequest" as const,
...
export const UpdateAddressRequest_LabelsEntry = {
  $type: "networkapi.UpdateAddressRequest.LabelsEntry" as const,
...
export const UpdateAddressMetadata = {
  $type: "networkapi.UpdateAddressMetadata" as const,
...
export const DeleteAddressRequest = {
  $type: "networkapi.DeleteAddressRequest" as const,
...
export const DeleteAddressMetadata = {
  $type: "networkapi.DeleteAddressMetadata" as const,
...
export const ListAddressOperationsRequest = {
  $type: "networkapi.ListAddressOperationsRequest" as const,
...
export const ListAddressOperationsResponse = {
  $type: "networkapi.ListAddressOperationsResponse" as const,
...
export const MoveAddressRequest = {
  $type: "networkapi.MoveAddressRequest" as const,
...
export const MoveAddressMetadata = {
  $type: "networkapi.MoveAddressMetadata" as const,
...
export const AddressServiceService = {
   ...
   */
  get: {
    path: "/networkapi.AddressService/Get",
    requestStream: false,
   ...
   */
  getByValue: {
    path: "/networkapi.AddressService/GetByValue",
    requestStream: false,
    responseStream: false,
  ...
  list: {
    path: "/networkapi.AddressService/List",
    requestStream: false,
    responseStream: false,
  ...
  create: {
    path: "/networkapi.AddressService/Create",
    requestStream: false,
    responseStream: false,
  ...
  update: {
    path: "/networkapi.AddressService/Update",
    requestStream: false,
    responseStream: false,
  ...
  delete: {
    path: "/networkapi.AddressService/Delete",
    requestStream: false,
    responseStream: false,
  ...
  listOperations: {
    path: "/networkapi.AddressService/ListOperations",
    requestStream: false,
    responseStream: false,
  ...
  move: {
    path: "/networkapi.AddressService/Move",
    requestStream: false,
    responseStream: false,
