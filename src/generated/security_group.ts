...
export interface SecurityGroup_LabelsEntry {
  $type: "networkapi.SecurityGroup.LabelsEntry";
  key: string;
  value: string;
}

export interface SecurityGroupRule {
  $type: "networkapi.SecurityGroupRule";
...
export interface SecurityGroupRule_LabelsEntry {
  $type: "networkapi.SecurityGroupRule.LabelsEntry";
  key: string;
  value: string;
}

export interface PortRange {
  $type: "networkapi.PortRange";
  fromPort: number;
  toPort: number;
}

export interface CidrBlocks {
  $type: "networkapi.CidrBlocks";
  v4CidrBlocks: string[];
  v6CidrBlocks: string[];
}
...
export const SecurityGroup = {
  $type: "networkapi.SecurityGroup" as const,
...
export const SecurityGroup_LabelsEntry = {
  $type: "networkapi.SecurityGroup.LabelsEntry" as const,
...
export const SecurityGroupRule = {
  $type: "networkapi.SecurityGroupRule" as const,
...
export const SecurityGroupRule_LabelsEntry = {
  $type: "networkapi.SecurityGroupRule.LabelsEntry" as const,
...
export const PortRange = {
  $type: "networkapi.PortRange" as const,
...
export const CidrBlocks = {
  $type: "networkapi.CidrBlocks" as const,
