...
export interface GetRouteTableRequest {
  $type: "networkapi.GetRouteTableRequest";
  /**
...
export interface ListRouteTablesRequest {
  $type: "networkapi.ListRouteTablesRequest";
  /**
...
export interface ListRouteTablesResponse {
  $type: "networkapi.ListRouteTablesResponse";
...
export interface CreateRouteTableRequest {
  $type: "networkapi.CreateRouteTableRequest";
  /**
   * ID of the folder that the route table belongs to.
   * To get the folder ID use a [yandex.cloud.resourcemanager.v1.FolderService.List] request.
   */
...
export interface CreateRouteTableRequest_LabelsEntry {
  $type: "networkapi.CreateRouteTableRequest.LabelsEntry";
  key: string;
  value: string;
}

export interface CreateRouteTableMetadata {
  $type: "networkapi.CreateRouteTableMetadata";
  /** ID of the route table that is being created. */
  routeTableId: string;
}

export interface UpdateRouteTableRequest {
  $type: "networkapi.UpdateRouteTableRequest";
...
export interface UpdateRouteTableRequest_LabelsEntry {
  $type: "networkapi.UpdateRouteTableRequest.LabelsEntry";
  key: string;
  value: string;
}

export interface UpdateRouteTableMetadata {
  $type: "networkapi.UpdateRouteTableMetadata";
  /** ID of the RouteTable resource that is being updated. */
  routeTableId: string;
}

export interface DeleteRouteTableRequest {
  $type: "networkapi.DeleteRouteTableRequest";
  /**
...
export interface ListRouteTableOperationsResponse {
  $type: "networkapi.ListRouteTableOperationsResponse";
...
export interface MoveRouteTableRequest {
  $type: "networkapi.MoveRouteTableRequest";
...
export interface MoveRouteTableMetadata {
  $type: "networkapi.MoveRouteTableMetadata";
...
export const GetRouteTableRequest = {
  $type: "networkapi.GetRouteTableRequest" as const,
...
export const ListRouteTablesRequest = {
  $type: "networkapi.ListRouteTablesRequest" as const,
...
export const ListRouteTablesResponse = {
  $type: "networkapi.ListRouteTablesResponse" as const,
...
export const CreateRouteTableRequest = {
  $type: "networkapi.CreateRouteTableRequest" as const,
...
export const CreateRouteTableRequest_LabelsEntry = {
  $type: "networkapi.CreateRouteTableRequest.LabelsEntry" as const,
...
export const CreateRouteTableMetadata = {
  $type: "networkapi.CreateRouteTableMetadata" as const,
...
export const UpdateRouteTableRequest = {
  $type: "networkapi.UpdateRouteTableRequest" as const,
...
export const UpdateRouteTableRequest_LabelsEntry = {
  $type: "networkapi.UpdateRouteTableRequest.LabelsEntry" as const,
...
export const UpdateRouteTableMetadata = {
  $type: "networkapi.UpdateRouteTableMetadata" as const,
...
export const DeleteRouteTableRequest = {
  $type: "networkapi.DeleteRouteTableRequest" as const,
...
export const DeleteRouteTableMetadata = {
  $type: "networkapi.DeleteRouteTableMetadata" as const,
...
export const ListRouteTableOperationsRequest = {
  $type: "networkapi.ListRouteTableOperationsRequest" as const,
...
export const ListRouteTableOperationsResponse = {
  $type: "networkapi.ListRouteTableOperationsResponse" as const,
...
export const MoveRouteTableRequest = {
  $type: "networkapi.MoveRouteTableRequest" as const,
...
export const MoveRouteTableMetadata = {
  $type: "networkapi.MoveRouteTableMetadata" as const,
...
export const RouteTableServiceService = {
   ...
   */
  get: {
    path: "/networkapi.RouteTableService/Get",
    requestStream: false,
  ...
  list: {
    path: "/networkapi.RouteTableService/List",
    requestStream: false,
    responseStream: false,
   ...
   */
  create: {
    path: "/networkapi.RouteTableService/Create",
    requestStream: false,
    responseStream: false,
   ...
   */
  update: {
    path: "/networkapi.RouteTableService/Update",
    requestStream: false,
    responseStream: false,
  ...
  delete: {
    path: "/networkapi.RouteTableService/Delete",
    requestStream: false,
    responseStream: false,
  ...
  listOperations: {
    path: "/networkapi.RouteTableService/ListOperations",
    requestStream: false,
    responseStream: false,
  ...
  move: {
    path: "/networkapi.RouteTableService/Move",
    requestStream: false,
    responseStream: false,
