...
export interface Subnet_LabelsEntry {
  $type: "networkapi.Subnet.LabelsEntry";
  key: string;
  value: string;
}

export interface DhcpOptions {
  $type: "networkapi.DhcpOptions";
...
export const Subnet = {
  $type: "networkapi.Subnet" as const,
...
export const Subnet_LabelsEntry = {
  $type: "networkapi.Subnet.LabelsEntry" as const,
...
export const DhcpOptions = {
  $type: "networkapi.DhcpOptions" as const,
