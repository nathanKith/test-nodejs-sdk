...
export interface Gateway_LabelsEntry {
  $type: "networkapi.Gateway.LabelsEntry";
  key: string;
  value: string;
}
...
export interface SharedEgressGateway {
  $type: "networkapi.SharedEgressGateway";
}
...
export const Gateway = {
  $type: "networkapi.Gateway" as const,
...
export const Gateway_LabelsEntry = {
  $type: "networkapi.Gateway.LabelsEntry" as const,
...
export const SharedEgressGateway = {
  $type: "networkapi.SharedEgressGateway" as const,
