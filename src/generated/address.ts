...
export interface Address_LabelsEntry {
  $type: "networkapi.Address.LabelsEntry";
  key: string;
  value: string;
}

export interface ExternalIpv4Address {
  $type: "networkapi.ExternalIpv4Address";
  /** Value of address. */
  address: string;
...
export interface AddressRequirements {
  $type: "networkapi.AddressRequirements";
...
export const Address = {
  $type: "networkapi.Address" as const,
...
export const Address_LabelsEntry = {
  $type: "networkapi.Address.LabelsEntry" as const,
...
export const ExternalIpv4Address = {
  $type: "networkapi.ExternalIpv4Address" as const,
...
export const AddressRequirements = {
  $type: "networkapi.AddressRequirements" as const,
