...
export interface GetSecurityGroupRequest {
  $type: "networkapi.GetSecurityGroupRequest";
  securityGroupId: string;
}

export interface ListSecurityGroupsRequest {
  $type: "networkapi.ListSecurityGroupsRequest";
  folderId: string;
  pageSize: number;
  pageToken: string;
...
export interface ListSecurityGroupsResponse {
  $type: "networkapi.ListSecurityGroupsResponse";
  securityGroups: SecurityGroup[];
  nextPageToken: string;
}

export interface CreateSecurityGroupRequest {
  $type: "networkapi.CreateSecurityGroupRequest";
  folderId: string;
  name: string;
  description: string;
...
export interface CreateSecurityGroupRequest_LabelsEntry {
  $type: "networkapi.CreateSecurityGroupRequest.LabelsEntry";
  key: string;
  value: string;
}

export interface SecurityGroupRuleSpec {
  $type: "networkapi.SecurityGroupRuleSpec";
  description: string;
  labels: { [key: string]: string };
...
export interface SecurityGroupRuleSpec_LabelsEntry {
  $type: "networkapi.SecurityGroupRuleSpec.LabelsEntry";
  key: string;
  value: string;
}

export interface CreateSecurityGroupMetadata {
  $type: "networkapi.CreateSecurityGroupMetadata";
  securityGroupId: string;
}

export interface UpdateSecurityGroupRequest {
  $type: "networkapi.UpdateSecurityGroupRequest";
  securityGroupId: string;
...
export interface UpdateSecurityGroupRequest_LabelsEntry {
  $type: "networkapi.UpdateSecurityGroupRequest.LabelsEntry";
  key: string;
  value: string;
}

export interface UpdateSecurityGroupMetadata {
  $type: "networkapi.UpdateSecurityGroupMetadata";
  securityGroupId: string;
  addedRuleIds: string[];
}

export interface UpdateSecurityGroupRulesRequest {
  $type: "networkapi.UpdateSecurityGroupRulesRequest";
  securityGroupId: string;
...
export interface UpdateSecurityGroupRuleRequest {
  $type: "networkapi.UpdateSecurityGroupRuleRequest";
  securityGroupId: string;
  ruleId: string;
  updateMask?: FieldMask;
  description: string;
...
export interface UpdateSecurityGroupRuleRequest_LabelsEntry {
  $type: "networkapi.UpdateSecurityGroupRuleRequest.LabelsEntry";
  key: string;
  value: string;
}

export interface UpdateSecurityGroupRuleMetadata {
  $type: "networkapi.UpdateSecurityGroupRuleMetadata";
  securityGroupId: string;
  ruleId: string;
}

export interface DeleteSecurityGroupRequest {
  $type: "networkapi.DeleteSecurityGroupRequest";
  securityGroupId: string;
}

export interface DeleteSecurityGroupMetadata {
  $type: "networkapi.DeleteSecurityGroupMetadata";
  securityGroupId: string;
}

export interface ListSecurityGroupOperationsRequest {
  $type: "networkapi.ListSecurityGroupOperationsRequest";
  securityGroupId: string;
  pageSize: number;
  pageToken: string;
}
...
export interface ListSecurityGroupOperationsResponse {
  $type: "networkapi.ListSecurityGroupOperationsResponse";
  operations: Operation[];
  nextPageToken: string;
}

export interface MoveSecurityGroupRequest {
  $type: "networkapi.MoveSecurityGroupRequest";
  securityGroupId: string;
  destinationFolderId: string;
}

export interface MoveSecurityGroupMetadata {
  $type: "networkapi.MoveSecurityGroupMetadata";
  securityGroupId: string;
}
...
export const GetSecurityGroupRequest = {
  $type: "networkapi.GetSecurityGroupRequest" as const,
...
export const ListSecurityGroupsRequest = {
  $type: "networkapi.ListSecurityGroupsRequest" as const,
...
export const ListSecurityGroupsResponse = {
  $type: "networkapi.ListSecurityGroupsResponse" as const,
...
export const CreateSecurityGroupRequest = {
  $type: "networkapi.CreateSecurityGroupRequest" as const,
...
export const CreateSecurityGroupRequest_LabelsEntry = {
  $type: "networkapi.CreateSecurityGroupRequest.LabelsEntry" as const,
...
export const SecurityGroupRuleSpec = {
  $type: "networkapi.SecurityGroupRuleSpec" as const,
...
export const SecurityGroupRuleSpec_LabelsEntry = {
  $type: "networkapi.SecurityGroupRuleSpec.LabelsEntry" as const,
...
export const CreateSecurityGroupMetadata = {
  $type: "networkapi.CreateSecurityGroupMetadata" as const,
...
export const UpdateSecurityGroupRequest = {
  $type: "networkapi.UpdateSecurityGroupRequest" as const,
...
export const UpdateSecurityGroupRequest_LabelsEntry = {
  $type: "networkapi.UpdateSecurityGroupRequest.LabelsEntry" as const,
...
export const UpdateSecurityGroupMetadata = {
  $type: "networkapi.UpdateSecurityGroupMetadata" as const,
...
export const UpdateSecurityGroupRulesRequest = {
  $type: "networkapi.UpdateSecurityGroupRulesRequest" as const,
...
export const UpdateSecurityGroupRuleRequest = {
  $type: "networkapi.UpdateSecurityGroupRuleRequest" as const,
  ...
  encode(
    ...
    Object.entries(message.labels).forEach(([key, value]) => {
      UpdateSecurityGroupRuleRequest_LabelsEntry.encode(
        {
          $type:
            "networkapi.UpdateSecurityGroupRuleRequest.LabelsEntry",
          key: key as any,
          value,
        },
        writer.uint32(42).fork()
...
export const UpdateSecurityGroupRuleRequest_LabelsEntry = {
  $type:
    "networkapi.UpdateSecurityGroupRuleRequest.LabelsEntry" as const,
...
export const UpdateSecurityGroupRuleMetadata = {
  $type: "networkapi.UpdateSecurityGroupRuleMetadata" as const,
...
export const DeleteSecurityGroupRequest = {
  $type: "networkapi.DeleteSecurityGroupRequest" as const,
...
export const DeleteSecurityGroupMetadata = {
  $type: "networkapi.DeleteSecurityGroupMetadata" as const,
...
export const ListSecurityGroupOperationsRequest = {
  $type: "networkapi.ListSecurityGroupOperationsRequest" as const,
...
export const ListSecurityGroupOperationsResponse = {
  $type: "networkapi.ListSecurityGroupOperationsResponse" as const,
...
export const MoveSecurityGroupRequest = {
  $type: "networkapi.MoveSecurityGroupRequest" as const,
...
export const MoveSecurityGroupMetadata = {
  $type: "networkapi.MoveSecurityGroupMetadata" as const,
...
export const SecurityGroupServiceService = {
  get: {
    path: "/networkapi.SecurityGroupService/Get",
    requestStream: false,
  ...
  list: {
    path: "/networkapi.SecurityGroupService/List",
    requestStream: false,
    responseStream: false,
  ...
  create: {
    path: "/networkapi.SecurityGroupService/Create",
    requestStream: false,
    responseStream: false,
  ...
  update: {
    path: "/networkapi.SecurityGroupService/Update",
    requestStream: false,
    responseStream: false,
  ...
  updateRules: {
    path: "/networkapi.SecurityGroupService/UpdateRules",
    requestStream: false,
    responseStream: false,
  ...
  updateRule: {
    path: "/networkapi.SecurityGroupService/UpdateRule",
    requestStream: false,
    responseStream: false,
  ...
  delete: {
    path: "/networkapi.SecurityGroupService/Delete",
    requestStream: false,
    responseStream: false,
  ...
  move: {
    path: "/networkapi.SecurityGroupService/Move",
    requestStream: false,
    responseStream: false,
  ...
  listOperations: {
    path: "/networkapi.SecurityGroupService/ListOperations",
    requestStream: false,
    responseStream: false,
...
export const SecurityGroupServiceClient = makeGenericClientConstructor(
  ...
  "networkapi.SecurityGroupService"
) as unknown as {
  new (
    address: string,
