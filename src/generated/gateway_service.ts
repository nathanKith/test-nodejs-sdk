...
export const protobufPackage = "networkapi";

export interface GetGatewayRequest {
  $type: "networkapi.GetGatewayRequest";
  /**
...
export interface ListGatewaysRequest {
  $type: "networkapi.ListGatewaysRequest";
  /**
...
export interface ListGatewaysResponse {
  $type: "networkapi.ListGatewaysResponse";
  /** List of gateways. */
  gateways: Gateway[];
  /**
...
export interface ListGatewayOperationsRequest {
  $type: "networkapi.ListGatewayOperationsRequest";
  /**
...
export interface ListGatewayOperationsResponse {
  $type: "networkapi.ListGatewayOperationsResponse";
...
export interface SharedEgressGatewaySpec {
  $type: "networkapi.SharedEgressGatewaySpec";
}

export interface CreateGatewayRequest {
  $type: "networkapi.CreateGatewayRequest";
  /**
...
export interface CreateGatewayRequest_LabelsEntry {
  $type: "networkapi.CreateGatewayRequest.LabelsEntry";
  key: string;
  value: string;
}

export interface CreateGatewayMetadata {
  $type: "networkapi.CreateGatewayMetadata";
  /** ID of the gateway that is being created. */
  gatewayId: string;
}

export interface UpdateGatewayRequest {
  $type: "networkapi.UpdateGatewayRequest";
  /**
...
export interface UpdateGatewayRequest_LabelsEntry {
  $type: "networkapi.UpdateGatewayRequest.LabelsEntry";
  key: string;
  value: string;
}

export interface UpdateGatewayMetadata {
  $type: "networkapi.UpdateGatewayMetadata";
  /** ID of the Gateway that is being updated. */
  gatewayId: string;
}

export interface DeleteGatewayRequest {
  $type: "networkapi.DeleteGatewayRequest";
  /**
...
export const GetGatewayRequest = {
  $type: "networkapi.GetGatewayRequest" as const,
  ...
  fromPartial<I extends Exact<DeepPartial<GetGatewayRequest>, I>>(
    object: I
  ): GetGatewayRequest {
    const message = { ...baseGetGatewayRequest } as GetGatewayRequest;
...
export const ListGatewaysRequest = {
  $type: "networkapi.ListGatewaysRequest" as const,
...
export const ListGatewaysResponse = {
  $type: "networkapi.ListGatewaysResponse" as const,
  ...
  fromJSON(object: any): ListGatewaysResponse {
    const message = { ...baseListGatewaysResponse } as ListGatewaysResponse;
    message.gateways = (object.gateways ?? []).map((e: any) =>
      Gateway.fromJSON(e)
    );
  ...
  fromPartial<I extends Exact<DeepPartial<ListGatewaysResponse>, I>>(
    ...
    const message = { ...baseListGatewaysResponse } as ListGatewaysResponse;
    message.gateways =
      object.gateways?.map((e) => Gateway.fromPartial(e)) || [];
...
export const ListGatewayOperationsRequest = {
  $type: "networkapi.ListGatewayOperationsRequest" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListGatewayOperationsRequest,
    } as ListGatewayOperationsRequest;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
messageTypeRegistry.set(
  ListGatewayOperationsRequest.$type,
  ListGatewayOperationsRequest
);
...
export const ListGatewayOperationsResponse = {
  $type: "networkapi.ListGatewayOperationsResponse" as const,
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseListGatewayOperationsResponse,
    } as ListGatewayOperationsResponse;
    message.operations = [];
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
...
messageTypeRegistry.set(
  ListGatewayOperationsResponse.$type,
  ListGatewayOperationsResponse
);
...
export const SharedEgressGatewaySpec = {
  $type: "networkapi.SharedEgressGatewaySpec" as const,

  encode(
    _: SharedEgressGatewaySpec,
    writer: _m0.Writer = _m0.Writer.create()
  ): _m0.Writer {
    return writer;
  },
  ...
  decode(
    ...
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = {
      ...baseSharedEgressGatewaySpec,
    } as SharedEgressGatewaySpec;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        default:
...
export const CreateGatewayRequest = {
  $type: "networkapi.CreateGatewayRequest" as const,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          break;
        case 4:
          const entry4 = CreateGatewayRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
...
export const CreateGatewayRequest_LabelsEntry = {
  $type: "networkapi.CreateGatewayRequest.LabelsEntry" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<CreateGatewayRequest_LabelsEntry>, I>
  >(object: I): CreateGatewayRequest_LabelsEntry {
    const message = {
      ...baseCreateGatewayRequest_LabelsEntry,
    } as CreateGatewayRequest_LabelsEntry;
...
messageTypeRegistry.set(
  CreateGatewayRequest_LabelsEntry.$type,
  CreateGatewayRequest_LabelsEntry
);
...
export const CreateGatewayMetadata = {
  $type: "networkapi.CreateGatewayMetadata" as const,
...
export const UpdateGatewayRequest = {
  $type: "networkapi.UpdateGatewayRequest" as const,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          const entry5 = UpdateGatewayRequest_LabelsEntry.decode(
            reader,
            reader.uint32()
          );
...
export const UpdateGatewayRequest_LabelsEntry = {
  $type: "networkapi.UpdateGatewayRequest.LabelsEntry" as const,
  ...
  fromPartial<
    I extends Exact<DeepPartial<UpdateGatewayRequest_LabelsEntry>, I>
  >(object: I): UpdateGatewayRequest_LabelsEntry {
    const message = {
      ...baseUpdateGatewayRequest_LabelsEntry,
    } as UpdateGatewayRequest_LabelsEntry;
    message.key = object.key ?? "";
...
messageTypeRegistry.set(
  UpdateGatewayRequest_LabelsEntry.$type,
  UpdateGatewayRequest_LabelsEntry
);
...
export const UpdateGatewayMetadata = {
  $type: "networkapi.UpdateGatewayMetadata" as const,
...
export const DeleteGatewayRequest = {
  $type: "networkapi.DeleteGatewayRequest" as const,
...
export const DeleteGatewayMetadata = {
  $type: "networkapi.DeleteGatewayMetadata" as const,
...
export const MoveGatewayRequest = {
  $type: "networkapi.MoveGatewayRequest" as const,
...
export const MoveGatewayMetadata = {
  $type: "networkapi.MoveGatewayMetadata" as const,
...
export const GatewayServiceService = {
   ...
   */
  get: {
    path: "/networkapi.GatewayService/Get",
    requestStream: false,
  ...
  create: {
    path: "/networkapi.GatewayService/Create",
    requestStream: false,
    responseStream: false,
  ...
  update: {
    path: "/networkapi.GatewayService/Update",
    requestStream: false,
    responseStream: false,
  ...
  delete: {
    path: "/networkapi.GatewayService/Delete",
    requestStream: false,
    responseStream: false,
...
export interface GatewayServiceClient extends Client {
  ...
  listOperations(
    ...
    callback: (
      error: ServiceError | null,
      response: ListGatewayOperationsResponse
    ) => void
  ): ClientUnaryCall;
  listOperations(
    request: ListGatewayOperationsRequest,
